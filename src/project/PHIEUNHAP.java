...
public class PHIEUNHAP{
    ...
    PHIEUNHAP(String idPN, int employeeID, String supplier, String date, long totalMoney, CHITIETPN [] ctpn) {
        this.idPN = idPN;
    ...
    public void khoiTaoPN(KHO kho, DSNCC dsncc, int manv){
        nhapMaPN();
        setEmployeeID(manv);
        nhapNCC(dsncc);
        khoiTaoNgayNhap();
    ...
    //Tao 1 phieu nhap moi
    public void khoiTaoPN(String mapn, KHO kho, DSNCC dsncc, int manv){
        setIdPN(mapn);
        setEmployeeID(manv);
        nhapNCC(dsncc);
        khoiTaoNgayNhap();
