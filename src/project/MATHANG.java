...
public abstract class MATHANG{
   ...
   MATHANG(){
    ...
    MATHANG(String id, String name, long price, String exp, String unit, int quantity, String condition, String type) {
        this.id = id;
        this.name = name;
        this.price = price;
        this.exp = exp;
    ...
    public void xuatMHChoKhach(){
        //System.out.printf("%-15s%-40s%-20s%-20s%-10s\t%-14s\n" ,"Ma mat hang", "Ten mat hang", "Gia", "HSD", "So luong", "Don vi tinh");
        System.out.printf("%-15s%-40s%-,20d%-20s%-10d\t%-14s\n" ,id, name, price, exp, quantity, unit);
    }
}